...
class FinalLaw:
    def __init__(self, chosen_philosophy="communist",
        ...
        self.communist_description = [
            "This is the current government that we are using.",
            "All/almost all resources and isk are shared and available for communal use.",
            "All isk made by individual members are pooled into a corporate wallet.",
            "Materials generated by members are pooled according to the desires of that member.",
            "Members are free to use communal isk/materials according to a 'don't be a dick' policy.",
            "Thus far, we haven't defined too many rules/guidelines, but there hasn't been much reason to since our corp is small."
        ]
        ...
        self.communist_detriments = [
            ...
            "Given that members contribute the majority of their earnings, may need a cash-out policy",
        ...
        self.socialist_benefits = [
            "Closer to what Eve players expect, so recruitment would be easier",
            "Easier to manage"
        ]
        self.socialist_detriments = [
            "Less top-down control",
            "Smaller group isk pool",
            "Specialization can occur, but usually with some individual cost"
        ]
